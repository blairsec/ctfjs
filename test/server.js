      ...
      it('200 | gets all competitions', function (done) {
        request(app)
          ...
          .then(response => {
            ...
            assert.strictEqual(typeof competition.created, 'string')
      ...
      it('200 | gets all users', function (done) {
        request(app)
          ...
          .then(function (response) {
            ...
            var user = response.body.filter(u => u.id === 3)[0]
    ...
    describe('GET /competitions/{id}/teams', function () {
      it('200 | gets a list of teams with trimmed team name', function (done) {
        request(app)
          ...
          .then(function (response) {
            assert.strictEqual(response.body.length, 3)
            var team = response.body.filter(t => t.id === 1)[0]
            ...
            assert.strictEqual(response.body.filter(t => t.id === 2)[0].eligible, true)
